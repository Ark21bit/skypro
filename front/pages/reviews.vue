<template>
    <div class="col-span-full w-full h-48 bg-cover bg-top bg-[url(/images/reviews/bg.jpg)] py-8 lg:py-12 -mt-8 lg:-mt-12 relative">
    ...
    <div class="flex flex-col gap-4 w-full rounded-2xl bg-cover bg-center bg-[url(/images/reviews/job.jpg)] relative justify-center overflow-hidden p-4">
        ...
        <button class="w-full rounded-full bg-[#829D32] text-white transition-colors duration-500 hover: px-5 py-3 text-lg md:text-xl z-10">Хочу новые знания</button>
    </div>
</template>
