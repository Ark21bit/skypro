<template>
    ...
    <div class="flex flex-col gap-6 md:gap-8" v-if="user">
        ...
        <FormKit @submit="addReview" id="addReview" type="form" form-class="flex flex-col gap-2 items-center" :actions="false">
            ...
            <button type="button" @click="message.title = null" class="flex items-center gap-4 px-6 py-2 rounded-2xl w-fit" :class="message.type? 'shadow-[0_0_20px_-7px]' : 'bg-red-500'" v-if="message.title">
