    ...
    <div class="flex flex-col gap-6 md:gap-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="flex gap-4">
                <img src="https://thumb.tildacdn.com/tild6230-3264-4131-b062-343939623236/-/cover/144x144/center/center/-/format/webp/Mask_Group.png" alt="" class="rounded-md w-24 md:w-28">
                <div class="flex flex-col gap-2">
                    <p class="text-[#787878] text-sm md:text-base">Имя Фамилия</p>
                    <p class="text-base md:text-lg">Руководитель руководителей</p>
                </div>
            </div>
            <div class="flex gap-4">
                <img src="https://thumb.tildacdn.com/tild6230-3264-4131-b062-343939623236/-/cover/144x144/center/center/-/format/webp/Mask_Group.png" alt="" class="rounded-md w-24 md:w-28">
